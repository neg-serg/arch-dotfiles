# Generated by Powerlevel10k configuration wizard on 2021-02-19 at 20:59 IST.
...
# round separators, sharp heads, flat tails, 2 lines, solid, full frame, compact,
...
() {
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=24
