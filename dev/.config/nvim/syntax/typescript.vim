...
syn region typescriptComment start="/\*" end="\*/" contains=@Spell,@comments extend fold
"}}}
"" JSDoc support start"{{{
...
syn region typescriptStringB start=+`+ skip=+\\\\\|\\`+ end=+`+
      \ contains=typescriptSpecial,typescriptInterpolation,@htmlPreproc extend
...
syn region typescriptRegexp start=+/[^/*]+me=e-1 skip=+\\\\\|\\/+ end=+/[gi]\{0,2\}\s*$+ end=+/[gi]\{0,2\}\s*[;.,)\]}]+me=e-1 contains=@htmlPreproc oneline
...
" syntax region typescriptRegexp start=+/\(\*\|/\)\@!+ skip=+\\\\\|\\/+ end=+/[gim]\{,3}+ contains=typescriptSpecial,@htmlPreproc oneline
...
""""""""""""""""""""""""
syntax keyword typescriptBrowserObjects window
...
syntax keyword typescriptRepeat do while for of
...
syntax keyword typescriptException try catch throw finally
syntax keyword typescriptStorageClass let var const
"}}}

syntax keyword typescriptSpecialIdentifier this prototype arguments super constructor
syntax keyword typescriptBoolean true false
syntax keyword typescriptNull null
syntax keyword typescriptUndefined undefined
syntax keyword typescriptOperator delete new instanceof typeof in

"" Programm Keywords"{{{
syntax keyword typescriptSource import export from as declare namespace module
syntax keyword typescriptScope  public private protected static extends implements abstract get set

syntax match typescriptTypedefName /\h\k\+/ contained
syntax keyword typescriptTypedef type nextgroup=typescriptTypedefName skipwhite

syntax keyword typescriptStructure enum class interface function
syntax keyword typescriptType void any string boolean number
"}}}

"" Node.js globals
syntax keyword typescriptGlobal global

"" JavaScript Globals
syntax keyword typescriptGlobalObjects Array Boolean Date Function Infinity Math Number NaN Object Packages RegExp String JSON
syntax keyword typescriptErrors Error EvalError RangeError ReferenceError SyntaxError TypeError URIError

"" Deprecated/annoying keywords"{{{
" syntax keyword typescriptMessage alert confirm prompt status
" syntax keyword typescriptGlobal self top parent
" syntax keyword typescriptReserved int short byte long float char double
" syntax keyword typescriptReserved final native synchronized
" syntax keyword typescriptReserved throws goto transient debugger volatile package
"}}}
...
"}}}
" DOM2 Objects"{{{
  syntax keyword typescriptType DOMImplementation DocumentFragment Node NodeList NamedNodeMap CharacterData Attr Element Text Comment CDATASection DocumentType Notation Entity EntityReference ProcessingInstruction
...
" HTML events and internal variables"{{{
  syntax case ignore
  syntax keyword typescriptHtmlEvents onblur onclick oncontextmenu ondblclick onfocus onkeydown onkeypress
  syntax keyword typescriptHtmlEvents onkeyup onwheel onmousedown onmousemove onmouseout onmouseover onmouseup onresize
  syntax keyword typescriptHtmlEvents onload onsubmit
  syntax case match
"}}}
...
"" Code blocks
syntax cluster typescriptAll contains=typescriptComment,typescriptLineComment,typescriptDocComment,
            \typescriptStringD,typescriptStringS,typescriptStringB,typescriptRegexp,typescriptNumber,
            \typescriptFloat,typescriptDecorators,typescriptLabel,typescriptSource,typescriptType,
            \typescriptStructure,typescriptTypedef,typescriptScope,typescriptStorageClass,
            \typescriptOperator,typescriptBoolean,typescriptNull,typescriptUndefined,typescriptConditional,
            \typescriptGlobal,typescriptRepeat,typescriptBranch,typescriptStatement,typescriptGlobalObjects,
            \typescriptSpecialIdentifier,typescriptExceptions,typescriptException,
            \typescriptReserved,typescriptDeprecated,
            \typescriptDomErrNo,typescriptDomNodeConsts,typescriptHtmlEvents,typescriptDotNotation,
            \typescriptBrowserObjects,typescriptDOMObjects,typescriptAjaxObjects,
            \typescriptDOMMethods,typescriptHtmlElemProperties,typescriptDOMProperties,
            \typescriptEventListenerKeywords,typescriptEventListenerMethods,typescriptAjaxProperties,
            \typescriptAjaxMethods,typescriptFuncArg
...
if version >= 508 || !exists("did_typescript_syn_inits")
  ...
  HiLink typescriptScope Keyword
  HiLink typescriptStructure Structure
  HiLink typescriptTypedef Keyword
  HiLink typescriptTypedefName Type
  HiLink typescriptStorageClass StorageClass

  HiLink typescriptEndColons Comment
  ...
  HiLink typescriptUndefined Constant
  ...
  HiLink typescriptSource Include
