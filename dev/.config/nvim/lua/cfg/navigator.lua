...
require'navigator'.setup({
    ...
    lsp_signature_help=true, -- ray-x/lsp_signature plugin in navigator setup here. if it is nil, navigator will not init signature help
    signature_help_cfg=nil, -- ray-x/lsp_signature plugin in navigator, and pass in your own config to signature help
