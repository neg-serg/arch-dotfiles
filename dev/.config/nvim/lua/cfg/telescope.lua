...
map('n', '<M-C-o>', '<Cmd>lua require("telescope").lsp_dynamic_workspace_symbols<CR>')
map('n', '<M-o>', '<Cmd>lua require("telescope").lsp_document_symbols<CR>')
map('n', '<M-d>', '<Cmd>lua require("telescope").lsp_document_diagnostics<CR>')
