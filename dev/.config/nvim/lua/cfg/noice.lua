...
noice.setup({
    ...
    routes={
        ...
        {filter={event="msg_show", find="%d+ lines, %d+ bytes"}, opts={skip=true},},
        ...
        {filter={event="msg_show", find="line %d+ of %d+"}, opts={skip=true},},
        {filter={event="msg_show", find="%d+ line"}, opts={skip=true},},
