...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-treesitter', 'nvim-lspconfig', 'LuaSnip', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'wilder.nvim', 'packer.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'gitsigns.nvim', 'nvim-treesitter', 'LuaSnip', 'Comment.nvim', 'nvim-dap'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'gitsigns.nvim', 'nvim-treesitter', 'LuaSnip', 'Comment.nvim', 'nvim-dap'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
