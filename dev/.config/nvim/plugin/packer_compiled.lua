...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'nvim-dap', 'vim-repeat', 'Comment.nvim', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'LuaSnip', 'nvim-cmp', 'nvim-treesitter', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'nvim-dap', 'vim-repeat', 'Comment.nvim', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
