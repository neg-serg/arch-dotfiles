...
_G.packer_plugins = {
  ...
  ["lualine.nvim"] = {
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19cfg.statusline\frequire\0" },
    loaded = true,
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-ts-rainbow", "nvim-treesitter-endwise", "nvim-treesitter-textobjects" },
    commands = { "TSUpdate" },
...
try_loadstring("\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19cfg.statusline\frequire\0", "config", "lualine.nvim")
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'nvim-nonicons', 'nvim-web-devicons'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'LuaSnip', 'nvim-cmp', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'wilder.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-dap', 'LuaSnip', 'Comment.nvim', 'vim-matchup', 'vim-repeat', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-dap', 'LuaSnip', 'Comment.nvim', 'vim-matchup', 'vim-repeat', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
