...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-lspconfig', 'LuaSnip', 'nvim-cmp', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'LuaSnip', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'LuaSnip', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
