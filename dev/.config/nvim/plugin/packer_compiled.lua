...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-ts-rainbow", "nvim-treesitter-endwise" },
    commands = { "TSUpdate" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'nvim-treesitter', 'LuaSnip', 'gitsigns.nvim', 'Comment.nvim', 'nvim-dap', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'wilder.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'nvim-treesitter', 'LuaSnip', 'gitsigns.nvim', 'Comment.nvim', 'nvim-dap', 'vim-repeat'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
