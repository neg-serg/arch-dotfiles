...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-endwise", "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-ts-rainbow" },
    commands = { "TSUpdate" },
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
...
try_loadstring("\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19cfg.toggleterm\frequire\0", "config", "toggleterm.nvim")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-cmp', 'nvim-autopairs', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'wilder.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
