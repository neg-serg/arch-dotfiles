...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'LuaSnip', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'vim-matchup', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'LuaSnip', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'vim-matchup', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
