...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-textobjects", "nvim-treesitter-endwise", "nvim-treesitter-refactor" },
    commands = { "TSUpdate" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-matchup', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
