...
_G.packer_plugins = {
  ...
  ["fine-cmdline.nvim"] = {
    config = { "\27LJ\2\n+\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\16cfg.cmdline\frequire\0" },
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/fine-cmdline.nvim",
  ...
  ["nui.nvim"] = {
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/nui.nvim",
...
try_loadstring("\27LJ\2\n+\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\16cfg.cmdline\frequire\0", "config", "fine-cmdline.nvim")
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-autopairs', 'nvim-cmp', 'nvim-treesitter', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'LuaSnip', 'gitsigns.nvim', 'vim-matchup', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'LuaSnip', 'gitsigns.nvim', 'vim-matchup', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
