...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-endwise", "nvim-treesitter-textobjects", "nvim-treesitter-refactor" },
    commands = { "TSUpdate" },
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'LuaSnip', 'nvim-treesitter', 'nvim-dap', 'Comment.nvim', 'vim-repeat', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-treesitter', 'nvim-autopairs', 'nvim-lspconfig', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'LuaSnip', 'nvim-treesitter', 'nvim-dap', 'Comment.nvim', 'vim-repeat', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
