...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-rainbow", "nvim-treesitter-refactor", "nvim-treesitter-endwise", "nvim-treesitter-textobjects" },
    commands = { "TSUpdate" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-treesitter', 'nvim-lspconfig', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'vim-matchup', 'gitsigns.nvim', 'vim-repeat', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'vim-matchup', 'gitsigns.nvim', 'vim-repeat', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
