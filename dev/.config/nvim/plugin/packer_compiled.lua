...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'nvim-treesitter', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'LuaSnip', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'nvim-treesitter', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
