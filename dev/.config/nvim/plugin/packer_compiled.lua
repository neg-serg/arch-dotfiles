...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'Comment.nvim', 'LuaSnip', 'vim-repeat', 'gitsigns.nvim', 'nvim-dap', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'Comment.nvim', 'LuaSnip', 'vim-repeat', 'gitsigns.nvim', 'nvim-dap', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter', 'LuaSnip', 'nvim-cmp', 'nvim-lspconfig', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
