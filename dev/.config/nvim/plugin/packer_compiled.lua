...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'LuaSnip', 'nvim-cmp', 'nvim-autopairs', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-matchup', 'vim-repeat', 'nvim-dap', 'Comment.nvim', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
