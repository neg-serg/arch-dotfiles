...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'LuaSnip', 'vim-matchup', 'gitsigns.nvim', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'LuaSnip', 'vim-matchup', 'gitsigns.nvim', 'vim-repeat', 'nvim-dap', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
