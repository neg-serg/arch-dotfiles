...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-nvim-lsp-signature-help", "cmp-path" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-cmp', 'nvim-lspconfig', 'nvim-autopairs', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'Comment.nvim', 'vim-matchup', 'vim-repeat', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-dap'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-matchup', 'vim-repeat', 'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-dap'}, { event = "BufRead *" }, _G.packer_plugins)]]
