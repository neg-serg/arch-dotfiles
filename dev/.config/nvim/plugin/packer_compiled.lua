...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp_luasnip" },
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-lspconfig', 'LuaSnip', 'nvim-treesitter', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'nvim-nonicons'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-dap', 'gitsigns.nvim', 'vim-repeat', 'Comment.nvim', 'LuaSnip', 'nvim-treesitter', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-dap', 'gitsigns.nvim', 'vim-repeat', 'Comment.nvim', 'LuaSnip', 'nvim-treesitter', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
