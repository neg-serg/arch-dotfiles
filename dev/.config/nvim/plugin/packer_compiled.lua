...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-endwise", "nvim-ts-rainbow", "nvim-treesitter-textobjects" },
    commands = { "TSUpdate" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-dap', 'LuaSnip', 'Comment.nvim', 'gitsigns.nvim', 'vim-matchup', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-autopairs', 'LuaSnip', 'nvim-cmp', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-dap', 'LuaSnip', 'Comment.nvim', 'gitsigns.nvim', 'vim-matchup', 'vim-repeat'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
