...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp_luasnip", "cmp-nvim-lsp" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-dap', 'vim-repeat', 'Comment.nvim', 'vim-matchup'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'LuaSnip', 'gitsigns.nvim', 'nvim-treesitter', 'nvim-dap', 'vim-repeat', 'Comment.nvim', 'vim-matchup'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'LuaSnip', 'nvim-cmp', 'nvim-autopairs', 'nvim-treesitter', 'nvim-lspconfig'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
