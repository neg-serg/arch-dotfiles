...
_G.packer_plugins = {
  ...
  ["leap.nvim"] = {
    config = { "\27LJ\2\n(\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rcfg.leap\frequire\0" },
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
    url = "https://github.com/arkav/lualine-lsp-progress"
  },
  ["lualine.nvim"] = {
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nabla.nvim"] = {
    config = { "\27LJ\2\nk\0\0\5\0\6\0\b6\0\0\0009\0\1\0009\0\2\0'\2\3\0'\3\4\0'\4\5\0B\0\4\1K\0\1\0$:lua require\"nabla\".popup()<CR>\14<leader>p\6n\20nvim_set_keymap\bapi\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/neg/.local/share/nvim/site/pack/packer/opt/nabla.nvim",
    url = "https://github.com/github.com/jbyuki/nabla.nvim"
  },
  ["neg.nvim"] = {
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-textobjects", "nvim-treesitter-endwise", "nvim-ts-rainbow" },
    commands = { "TSUpdate" },
  ...
  ["todo-comments.nvim"] = {
    ...
    loaded = true,
    path = "/home/neg/.local/share/nvim/site/pack/packer/start/todo-comments.nvim",
...
try_loadstring("\27LJ\2\n(\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\rcfg.leap\frequire\0", "config", "leap.nvim")
...
vim.cmd [[noremap <silent> <leader>xx <cmd>lua require("packer.load")({'trouble.nvim'}, { keys = "<lt>leader>xx", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nabla.nvim', 'headlines.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType vimwiki ++once lua require("packer.load")({'nabla.nvim', 'headlines.nvim'}, { ft = "vimwiki" }, _G.packer_plugins)]]
vim.cmd [[au FileType org ++once lua require("packer.load")({'nabla.nvim', 'headlines.nvim'}, { ft = "org" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-lspconfig', 'nvim-treesitter', 'LuaSnip', 'nvim-cmp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'nvim-web-devicons'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'packer.nvim', 'wilder.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'Comment.nvim', 'vim-matchup', 'gitsigns.nvim', 'nvim-treesitter', 'LuaSnip', 'nvim-dap', 'vim-repeat'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'vim-matchup', 'gitsigns.nvim', 'nvim-treesitter', 'LuaSnip', 'nvim-dap', 'vim-repeat'}, { event = "BufRead *" }, _G.packer_plugins)]]
