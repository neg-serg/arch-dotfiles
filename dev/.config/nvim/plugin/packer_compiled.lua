...
_G.packer_plugins = {
  ...
  ["cmp-under-comparator"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/neg/.local/share/nvim/site/pack/packer/opt/cmp-under-comparator",
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-repeat', 'vim-matchup', 'LuaSnip', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'LuaSnip', 'nvim-treesitter'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-repeat', 'vim-matchup', 'LuaSnip', 'nvim-treesitter', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
